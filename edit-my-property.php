...
<body>
    ...
    <main class="container px py">
        <div class="top-bar">
            <h1>Editar Tour</h1>
            <a class="btn btn-secondary" href="<?php echo BASE_URL . "/tour/" . $slug ?>">Volver</a>
        </div>
        ...
        <section>
            ...
            ?>
            <form class="custom-form" action="./actions/update_my_property.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="property_id" name="property_id" value="<?php echo $property['id']; ?>">
                <input type="hidden" id="slug" name="slug" value="<?php echo $property['slug']; ?>">
                ...
                <div class="data-section">
                    ...
                    <div class="grid cols-3">
                        <?php include './admin/components/edit_price.php' ?>
                ...
                <div class="manage-section">
                    ...
                    <?php include './admin/components/thumbnail_field.php' ?>

                    <input id="submit-btn" class="btn btn-primary" type="submit" value="Actualizar Tour">

                    <a class="change-password" href="<?php echo BASE_URL ?>/manage-images.php?property_id=<?php echo $property["id"]; ?>">Administrar imágenes</a>

                    <a class="change-password" href="<?php echo BASE_URL ?>/manage-videos.php?property_id=<?php echo $property["id"]; ?>">Administrar videos</a>
                </div>
            </form>
