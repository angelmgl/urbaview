...
<div id="details-grid">
    ...
    <div class="detail has_terrace">
        <h3 class="detail-title">Terraza</h3>
        <p class="detail-content">No</p>
    </div>
    <div class="detail has_balcony">
        <h3 class="detail-title">Balcón</h3>
        <p class="detail-content">Si</p>
    </div>
    <div class="detail has_bathroom_furniture">
        <h3 class="detail-title">Mueble de baño</h3>
        <p class="detail-content">Si</p>
    </div>
    <div class="detail has_pool">
        <h3 class="detail-title">Piscina</h3>
        <p class="detail-content">Si</p>
    </div>
    ...
    <div class="detail has_kitchen_furniture">
        <h3 class="detail-title">Mueble de cocina</h3>
        <p class="detail-content">Si</p>
    </div>
    <div class="detail has_barbecue">
        <h3 class="detail-title">Parrilla</h3>
        <p class="detail-content">Si</p>
    </div>
    <div class="detail has_ac">
        <h3 class="detail-title">AC</h3>
        <p class="detail-content">No</p>
    </div>
</div>